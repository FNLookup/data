...
try:
    ...
    for lang in languages:
        ...
        while (rankedpage < allpages):
            result = str(driver.execute_script('fetch("https://www.fortnite.com/ranked/leaderboard?season=chapter-5-season-4&page=' + str(rankedpage + 1) + 'lang=en-US&_data=routes%2Franked.leaderboard._index").then(r=>r.text()).then(r => {return r});'))
            print(result)
