...
try:
    ...
    for lang in languages:
        ...
        while (rankedpage < allpages):
            result = str(driver.execute_script(f'return fetch("https://www.fortnite.com/ranked/leaderboard?season=chapter-5-season-4&page={rankedpage + 1}lang=en-US&_data=routes%2Franked.leaderboard._index").then(r=>r.text())'))
            print(result)
